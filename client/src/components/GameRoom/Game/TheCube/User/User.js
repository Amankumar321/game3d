...
const User = (props) => {
    ...
    useEffect(() => {
        ...
        loadStyles(user_doc, 'TheCube')

        const start = require('../../../../../utils/socket/games/TheCube/user.js').default
        start(index)    
    }, [])
